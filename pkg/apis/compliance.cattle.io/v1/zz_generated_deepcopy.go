...
func (in *BenchmarkMetadataSpec) DeepCopyInto(out *BenchmarkMetadataSpec) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BenchmarkMetadataSpec.
func (in *BenchmarkMetadataSpec) DeepCopy() *BenchmarkMetadataSpec {
	if in == nil {
		return nil
	}
	out := new(BenchmarkMetadataSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ClusterScanBenchmarkSpec) DeepCopyInto(out *ClusterScanBenchmarkSpec) {
	*out = *in
	out.BenchmarkMetadata = in.BenchmarkMetadata
	if in.StigChecks != nil {
		in, out := &in.StigChecks, &out.StigChecks
		*out = make(map[string]StigCheckSpec, len(*in))
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StigCheckSpec) DeepCopyInto(out *StigCheckSpec) {
	*out = *in
	if in.CCI != nil {
		in, out := &in.CCI, &out.CCI
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	return
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StigCheckSpec.
func (in *StigCheckSpec) DeepCopy() *StigCheckSpec {
	if in == nil {
		return nil
	}
	out := new(StigCheckSpec)
	in.DeepCopyInto(out)
	return out
}
